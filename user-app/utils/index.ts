...
// Image utilities
export const getImageUrl = (url: string | undefined, fallback = '/images/placeholder.jpg') => {
  return url || fallback;
};

export const getAvatarUrl = (name: string, size = 40) => {
  return `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&size=${size}&background=ec4899&color=ffffff`;
};
